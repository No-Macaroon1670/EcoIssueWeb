...
TITLES = {
    ...
    'carbon-sink-decline':        ('Carbon sink', 'exact'),
    ...
    'groundwater-depletion':         ('Overdrafting', 'exact'),
    'unsafe-water':        ('Sanitation', 'broad'),
    'salinization':        ('Saltwater intrusion', 'exact'),
    'glacier-water-loss':       ('Meltwater', 'broad'),
    'dams':                ('Dam', 'broad'),
    ...
    'pollinator-decline':         ('Pollinator decline', 'exact'),
    'insect-decline':      ('Decline in insect populations', 'exact'),
    'soil-biodiversity-loss':           ('Soil biology', 'exact'),
    'overfishing':         ('Overfishing', 'exact'),
    'coral-bleaching':     ('Coral bleaching', 'exact'),
    'kelp-seagrass-loss':       ('Kelp forest', 'proxy'),
